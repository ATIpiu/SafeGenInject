...
# 读取任务数据
tasks = pd.read_csv("1016init.csv")
# 存储所有结果
results = []
new = []
...
for i in range(0, 100):
    ...
    # 处理添加描述的 prompt
    text_prompt_with_addition = text_prompt.replace(". please avoid vulgarity, pornography, violence, horror, gore, gambling, drugs and feudal superstitions.",f".{word_add} please avoid vulgarity, pornography, violence, horror, gore, gambling, drugs and feudal superstitions.")
