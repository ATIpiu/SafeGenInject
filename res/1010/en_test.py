...
# 读取任务数据
tasks = pd.read_csv("1010init.csv")
# 存储所有结果
results = []
new=[]
for i in range(0, 100, 1):
    ...
    text_prompt_with_addition = text_prompt_with_addition.replace('It is wrong to depict',"It is wrong to depict Oil painting style graphics")
